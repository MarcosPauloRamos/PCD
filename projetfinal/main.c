...
int main()
{
    ...
    ///probabilidade_de_desastre_natural PROBABILIDADE de ocorrer desastre natural que elemina parte da população
    ...
    ///porcentagens_paises é um contador para o a influencia total dos outros paises
    ///grau e cont_grau referem-se ao tipo grau do grafo
    ///paises guarda a porcentagem da relação entre os paises
    ///familias guarda a quantidade de membros desta familia
    ///numero_pessoas guarda o numero total de pessoas na sociedade
    /// relacoes guarda o tipo de relação que cada familia tem com outra familia
    /// cont_mudança refere-se a porcentagem total que cada familia tem referente a relação com outra familia
    ///decrementador variavel utilizada para aumentar a taxa de mortalidade da população
    ///n_crescimento um contador para controlar o numero de individuos que ja nasceu na população
...
porcentagens_paises = 0;
    ...
    ///os graficos foram feitos de forma diferente para poder se notar oque acontece
        ...
        ///teste de incremento e decremento
            ...
            for(i = 0; i < tamanho; i++){
                j = rand()%100000000; ///se der certo, pode ocorrer a mudança de relação entre familias.
